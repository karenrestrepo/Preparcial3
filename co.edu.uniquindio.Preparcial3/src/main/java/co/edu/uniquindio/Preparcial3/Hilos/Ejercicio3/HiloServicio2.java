...
public class HiloServicio2 extends Thread {
    ...
    public HiloServicio2(String directorio, String palabra) {
    ...
    public void run() {
        ...
        for (File archivo : archivos) {
            try {
                ...
                if (ocurrencias > 0) {
                    contador += 1;
                    System.out.println("Hilo 2: Encontrada '" + palabra + "' en el archivo: " + archivo.getName());
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        System.out.println("Hilo 2: Encontrada '" + palabra + "' en " + contador + " archivos.");
    }
}